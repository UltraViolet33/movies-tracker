<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('movies.seen')" :active="request()->routeIs('movies.seen')">
                {{ __('My Movies') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('movies.wish')" :active="request()->routeIs('movies.wish')">
                {{ __('My Wish List') }}
            </x-responsive-nav-link>
        </div>
